 ...
 * @generated
 */
public class ContactInfoLocalServiceClp implements ContactInfoLocalService {
    ...
    public biz.fz5.app.kumquat.model.ContactInfo addContactInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(contactInfo) });
        } catch (Throwable t) {
        ...
        return (biz.fz5.app.kumquat.model.ContactInfo) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public biz.fz5.app.kumquat.model.ContactInfo createContactInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { contactInfoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public biz.fz5.app.kumquat.model.ContactInfo deleteContactInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { contactInfoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public biz.fz5.app.kumquat.model.ContactInfo fetchContactInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { contactInfoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public biz.fz5.app.kumquat.model.ContactInfo getContactInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { contactInfoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<biz.fz5.app.kumquat.model.ContactInfo> list(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    ...
                    new Object[] { contactGroupId, groupId, companyId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
